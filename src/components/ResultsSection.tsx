...
const StatCard = ({
  ...
  // Render the title with a highlighted word if specified
  const renderTitle = () => {
    ...
    if (highlightSecondLine) {
      ...
      return (
        <>
          <h3 className="text-lg text-gray-200 font-medium mb-2">{titleParts[0]}</h3>
        </>
      );
    }
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard 
            ...
            title="Resultados Expressivos Crescentes" 
            value="+" 
