...
const StatCard = ({
  ...
  const animatedCount = useCountUp(numericValue || 0, 2000, isVisible);
  ...
  const renderTitle = () => {
    if (highlightSecondLine) {
      ...
      return (
        <>
          <h3 className="text-lg text-gray-200 font-medium mb-1">
            {titleParts[0]}
          </h3>
        </>
      );
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Impulsionamos clínicas e consultórios através de estratégias
            digitais especializadas para a área da saúde
          </p>
        </div>
