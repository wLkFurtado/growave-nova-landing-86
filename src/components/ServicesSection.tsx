  ...
  return <section id="services" className="py-16 relative circuit-pattern">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <ServiceCard title="Chatbots para Pré-atendimento" description="Bots inteligentes para triagem inicial, esclarecimento de dúvidas e qualificação de pacientes antes da consulta." icon={<img alt="Chatbot" className="w-8 h-8" src="/lovable-uploads/71bac2a2-33c5-4cb3-bedf-d5f33c126426.png" />} delay={800} />
