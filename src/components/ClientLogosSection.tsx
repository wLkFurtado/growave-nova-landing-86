...
const ClientLogosSection = () => {
  ...
  return <section className="py-16 relative bg-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={ref}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 items-center">
            {clientLogos.map((partner, index) => <div key={partner.id} className="bg-white/5 backdrop-blur p-4 rounded-lg flex items-center justify-center h-20 transition-all duration-500" style={{
